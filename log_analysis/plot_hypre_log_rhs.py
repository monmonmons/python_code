...
if __name__=="__main__":
    #待读取文件的文件夹绝对地址
    file_path = '/home/dyt/test_filter/hypre_thmaxwell/filter_log/refine_1/rhs'
    dataframe_dir = "/home/dyt/test_filter/hypre_thmaxwell/table/filter_rhs_refine_1.xls"

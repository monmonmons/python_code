...
def get_par_from_filename(filename,dict):
    ...
    for i in range(0, len(list), 2):
        ...
        if string == 'rhs':
            ...
            dict["type"] = int(list[i+1].split(".")[0])
        elif string == 'rlxn':
            dict["rlxn"] = int(list[i+1].split(".")[0])
        elif string == 'smit':
            dict["smit"] = int(list[i+1].split(".")[0])
...
if __name__=="__main__":
    #待读取文件的文件夹绝对地址
    # file_path = '/home/dyt/test_filter/hypre_thmaxwell/sip_log/baseline'
    # dataframe_dir = "/home/dyt/test_filter/hypre_thmaxwell/table/sip_baseline.xls"
    
    file_path = '/home/dyt/test_filter/hypre_thmaxwell/sip_log/SM_AMG'
    dataframe_dir = "/home/dyt/test_filter/hypre_thmaxwell/table/sip_SM.xls"

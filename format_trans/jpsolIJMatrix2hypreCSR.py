...
if __name__=="__main__":
    ...
    if filter == 1:
        ...
        ##
        matrix = ['/home/dyt/matrix/filter_ams/refine_%d/hypre_IJ.M.00000' % refine,
                    '/home/dyt/matrix/filter_ams/refine_%d/hypre_IJ.G.00000' % refine]

        save_matrix = ['/home/dyt/matrix/filter_matrix_hypre/refine_%d/hypre_CSR.M' % refine,
        ...
        save_matrix = ['/home/dyt/matrix/SPD_matrix_hypre/refine_%d/hypre_CSR.A' % refine,
                        '/home/dyt/matrix/SPD_matrix_hypre/refine_%d/hypre_CSR.G' % refine]
